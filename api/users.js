    ...
    `,
            ...
            if (action === 'updateBatch') {
                ...
                const ALLOWED_BATCH_FIELDS = [
                    ...
                    'can_manage_retired_units','can_edit_legacy_terminal_type','access_marketing','access_terminal_types','access_all_tasks','access_task_dashboard','access_pos_express','access_pos_settings'
                ];
